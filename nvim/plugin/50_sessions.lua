local function log_info(s) vim.notify(s, vim.log.levels.INFO, { title = 'IGNACIO' }) end
...
local function get_last_session_file() return session_dir .. 'last_session.vim' end
