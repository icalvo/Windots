...
nmap_leader('fC', '<Cmd>FzfLua git_commits path="%"<CR>',         'Commits (buf)')
nmap_leader('fd', '<Cmd>FzfLua diagnostic scope="all"<CR>',       'Diagnostic workspace')
nmap_leader('fD', '<Cmd>FzfLua diagnostic scope="current"<CR>',   'Diagnostic buffer')
nmap_leader('ff', '<Cmd>FzfLua files<CR>',                        'Files')
nmap_leader('fg', '<Cmd>FzfLua grep_live<CR>',                    'Grep live')
nmap_leader('fG', '<Cmd>FzfLua grep_cword<cword>"<CR>',           'Grep current word')
nmap_leader('fh', '<Cmd>FzfLua help<CR>',                         'Help tags')
nmap_leader('fH', '<Cmd>FzfLua hl_groups<CR>',                    'Highlight groups')
nmap_leader('fl', '<Cmd>FzfLua buf_lines scope="all"<CR>',        'Lines (all)')
nmap_leader('fL', '<Cmd>FzfLua buf_lines scope="current"<CR>',    'Lines (buf)')
